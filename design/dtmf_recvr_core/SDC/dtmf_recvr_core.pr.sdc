...
create_clock [get_ports {refclk}]  -add  -name refclk -period 4 -waveform {0 2}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A98/ZN}]  -add  -name m_rcc_clk -period 4 -waveform {0 2}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A91/ZN}]  -add  -name m_ram_clk -period 4 -waveform {0 2}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A97/Z}]  -add  -name m_clk -period 4 -waveform {0 2}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A89/ZN}]  -add  -name m_dsram_clk -period 4 -waveform {0 2}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A90/ZN}]  -add  -name m_digit_clk -period 4 -waveform {0 2}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A88/ZN}]  -add  -name m_spi_clk -period 4 -waveform {0 2}
set_case_analysis 0 [get_ports {scan_en}]
set_case_analysis 0 [get_ports {test_mode}]
set_case_analysis 0 [get_ports {scan_se}]
set_wire_load_mode enclosed
set_false_path -hold -from [get_ports scan_se]
set_false_path -setup -from [get_ports scan_se]

set_input_delay -add_delay 4 -clock [get_clocks {refclk}] [get_ports {channelin}]
set_input_delay -add_delay 4 -clock [get_clocks {refclk}] [get_ports domain_ctrl*]
set_output_delay -add_delay 1 -clock [get_clocks {refclk}] [get_ports channelout*]
set_output_delay -add_delay 1 -clock [get_clocks {refclk}] [get_ports domain_enout*]
...
set_input_delay -add_delay 4.5 -clock [get_clocks {m_clk}] [get_ports {port_pad_data_in[4]}]
set_input_delay -add_delay 4.5 -clock [get_clocks {m_spi_clk}] [get_ports {port_pad_data_in[4]}]
set_input_delay -add_delay 4.5 -clock [get_clocks {m_dsram_clk}] [get_ports {port_pad_data_in[4]}]
