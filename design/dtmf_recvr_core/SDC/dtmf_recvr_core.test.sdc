...
create_clock [get_ports {refclk}]  -add  -name refclk -period 44 -waveform {0 22}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A98/ZN}]  -add  -name m_rcc_clk -period 44 -waveform {0 22}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A91/ZN}]  -add  -name m_ram_clk -period 44 -waveform {0 22}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A97/Z}]  -add  -name m_clk -period 44 -waveform {0 22}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A89/ZN}]  -add  -name m_dsram_clk -period 44 -waveform {0 22}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A90/ZN}]  -add  -name m_digit_clk -period 44 -waveform {0 22}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A88/ZN}]  -add  -name m_spi_clk -period 44 -waveform {0 22}
