...
create_clock [get_pins {TEST_CONTROL_INST/p214748365A98/ZN}]  -add  -name m_rcc_clk -period 40 -waveform {0 20}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A91/ZN}]  -add  -name m_ram_clk -period 40 -waveform {0 20}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A97/Z}]  -add  -name m_clk -period 40 -waveform {0 20}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A89/ZN}]  -add  -name m_dsram_clk -period 40 -waveform {0 20}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A90/ZN}]  -add  -name m_digit_clk -period 40 -waveform {0 20}
create_clock [get_pins {TEST_CONTROL_INST/p214748365A88/ZN}]  -add  -name m_spi_clk -period 40 -waveform {0 20}
set_case_analysis 0 [get_ports {scan_en}]
set_case_analysis 0 [get_ports {test_mode}]
#set_case_analysis 1 [get_ports {scan_se}]
set_wire_load_mode enclosed
set_false_path -hold -from [get_ports scan_se]
set_false_path -hold -from [all_registers] -to [all_registers]
set_multicycle_path 2 -setup  -from [get_ports {scan_se}]
set_multicycle_path 3 -hold  -from [get_ports {scan_se}]
